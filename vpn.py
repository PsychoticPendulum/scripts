...
def create_hostfile():
    ...
    if not os.path.isfile('/home/psychicpenguin/Developer/.scripts/assets/hostlist.txt'):
        print("No hostlist found. Creating new one ...")
        os.system("ls /etc/openvpn/ovpn_tcp >> /home/psychicpenguin/Developer/.scripts/assets/hostlist.txt")

def getLocation():
    VPN_CONNECT.location = str(input("Enter Country Code:\t"))

def read_hostlist():
    hostlist = open("/home/psychicpenguin/Developer/.scripts/assets/hostlist.txt", "r+")
